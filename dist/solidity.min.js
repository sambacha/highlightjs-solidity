...
(() => {
  const e = (() => {
    ...
    } let a, n, s, i; return e((() => {
      if (i) return s; i = 1
      ;const { baseAssembly: e, solAposStringMode: t, solQuoteStringMode: r, HEX_APOS_STRING_MODE: o, HEX_QUOTE_STRING_MODE: l, SOL_NUMBER: c, isNegativeLookbehindAvailable: d } = (() => {
...
;e() && (s = s.source.replace(/\\b/g, "(?<!\\$)\\b")); const i = {
          className: "number",
          begin: s,
          relevance: 0
        }; const t = {
          ...
          baseAssembly: e => {
            const a = l(e); const n = c(e); const s = e.inherit(e.TITLE_MODE, {
              ...
              excludeEnd: !0,
              keywords: t,
              contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, n, i]
            }; const u = { className: "operator", begin: /:=|->/ }; return {
              keywords: t,
              contains: [a, n, r, o, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, i, u, {
                className: "function",
...
;return s = a => {
        for (var n = t(a), s = r(a), i = [], u = 0; u < 32; u++)i[u] = u + 1
        ;const _ = i.map(e => 8 * e); const b = []; for (u = 0; u <= 80; u++)b[u] = u
        ;const g = i.map(e => "bytes" + e).join(" ") + " "; const p = _.map(e => "uint" + e).join(" ") + " "; const E = _.map(e => "int" + e).join(" ") + " "; const m = [].concat.apply([], _.map(e => b.map(a => e + "x" + a))); const M = {
          $pattern: /[A-Za-z_$][A-Za-z_$0-9]*/,
        ...
        }; const O = { className: "operator", begin: /[+\-!~*\/%<>&^|=]/ }; const N = {
          className: "params",
          begin: /\(/,
          end: /\)/,
          excludeBegin: !0,
          ...
          contains: [n, s, o, l, a.C_LINE_COMMENT_MODE, a.COMMENT("/\\*\\*", "\\*/", {
            ...
            excludeEnd: !0,
            contains: [C, N, y, a.C_LINE_COMMENT_MODE, a.C_BLOCK_COMMENT_MODE],
            illegal: /%/
            ...
            excludeEnd: !0,
            illegal: /[:"\[\]]/,
            contains: [{ beginKeywords: "is" }, C, N, y, a.C_LINE_COMMENT_MODE, a.C_BLOCK_COMMENT_MODE]
          }, {
  ...
  })(); hljs.registerLanguage("solidity", e);
})();
